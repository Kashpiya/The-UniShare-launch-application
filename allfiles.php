					...
					<div class='col-md-4' style='margin-bottom:30px;'>
						<div class='card'
							...
							<div class='card-body'>
								...
								<?php 
									$point=mysqli_query($con,"select point from user where id=$user_id ");                        			

									$row_point = mysqli_fetch_array($point);

									// echo $row_point['point'];

									if($row_point['point'] > 0){
								...
								<button type="button" class="btn btn-secondary cts" data-toggle="tooltip"
									data-placement="top" title="You don't have enough points" > 
									Download
								</button>
							...
							<div class="rating-reviews m-t-20">
								<div class="row">
									<div class="col-sm-12">
										...
										<a href="allfeedback.php?id=<?php echo $pro_id; ?>" class="lnk">(<?php echo htmlentities($num);?> Reviews)</a>
